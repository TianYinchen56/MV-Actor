        ...
        *,
        ...
        if self.need_pi3x:
            raise NotImplementedError(
                "Pi3X online geometry is not included in this evaluation-only release. "
                "Use --scene_geometry_source raw_pcd and --disable_geometry_fusion false/true as configured."
            )
        if self.scene_geometry_source == "vggt":
            raise NotImplementedError("VGGT online geometry is not included in this evaluation-only release.")
